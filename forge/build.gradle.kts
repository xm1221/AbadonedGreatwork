...
loom {
    forge {
        ...
        mixinConfig(
            "abadoned_greatwork-common.mixins.json",
            "abadoned_greatwork-forge.mixins.json",
        )
    }
    ...
    runs {
        for ((platform, outputProject) in arrayOf(
            ...
            register("${platform}Datagen") {
                ...
                property("abadoned_greatwork.apply-datagen-mixin", "true")
                property("abadoned_greatwork.$platform-datagen", "true")
            }
        }
    }
}

abadoned_greatworkModDependencies {
