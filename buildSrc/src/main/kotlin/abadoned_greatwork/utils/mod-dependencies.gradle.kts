package abadoned_greatwork.utils
...
abstract class Abadoned_greatworkModDependenciesExtension(private val project: Project) {
...
val extension = extensions.create<Abadoned_greatworkModDependenciesExtension>("abadoned_greatworkModDependencies")
