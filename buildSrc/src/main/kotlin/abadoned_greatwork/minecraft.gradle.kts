...
package abadoned_greatwork

import kotlin.io.path.div
import libs

plugins {
    id("abadoned_greatwork.java")
...
loom {
    ...
    accessWidenerPath = project(":common").file("src/main/resources/abadoned_greatwork.accesswidener")

    mixin {
        // the default name includes both archivesName and the subproject, resulting in the platform showing up twice
        // default: abadoned_greatwork-common-common-refmap.json
        // fixed:   abadoned_greatwork-common.refmap.json
